...
class Flowerprint {
  ...
  drawText(nval,expiration){
   ...
   fill(155,80)
    ...
    text(nval,this.posx+postx,this.posy+postx)
    fill(255,255,244)
    //text(this.bills[this.id],this.posx+postx-2,this.posy+postx-2)
    text(nval,this.posx+postx-2,this.posy+postx-2)

    textStyle(ITALIC)
    textSize(postx*0.7);
    fill(0)
    text('f',this.posx+postx,this.posy+postx*1.8)
    fill(255,255,244)
    text('f',this.posx+postx-2,this.posy+postx*1.8-2)
